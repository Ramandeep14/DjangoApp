...
<html lang="en" ng-strict-di=""><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><style type="text/css">@charset "UTF-8";[ng\:cloak],[ng-cloak],[data-ng-cloak],[x-ng-cloak],.ng-cloak,.x-ng-cloak,.ng-hide:not(.ng-hide-animate){display:none !important;}ng\:form{display:block;}.ng-animate-shim{visibility:hidden;}.ng-anchor{position:absolute;}</style>
  ...
  <link href="./Readme_files/css(1)" rel="stylesheet" type="text/css">
    ...
    <link rel="stylesheet" href="./Readme_files/app-035a187a41ca5aaa06aed70c27d4f01f.css">
  

  
  <script async="" src="./Readme_files/analytics.js.download"></script><script type="text/javascript">
...
<li>
  ...
  <!-- ngIf: profile.enableWordsCount && !viewSrcMode --><p ng-if="profile.enableWordsCount &amp;&amp; !viewSrcMode" class="words ng-scope">Words: <span class="counter ng-binding" ng-bind="words">129</span></p><!-- end ngIf: profile.enableWordsCount && !viewSrcMode -->
  <!-- ngIf: profile.enableCharactersCount && !viewSrcMode --><p ng-if="profile.enableCharactersCount &amp;&amp; !viewSrcMode" class="characters ng-scope">Characters: <span class="counter ng-binding" ng-bind="characters">841</span></p><!-- end ngIf: profile.enableCharactersCount && !viewSrcMode -->
</div>
...
<div class="editor-header">
  ...
  <div id="editor" class="ui-resizable-e ace_editor ace-dillinger" style="height: 1400px;"><textarea class="ace_text-input" wrap="off" autocapitalize="off" spellcheck="false" style="opacity: 0; height: 28px; width: 7px; left: 52px; top: 0px;"></textarea><div class="ace_gutter"><div class="ace_layer ace_gutter-layer ace_folding-enabled" style="margin-top: 0px; height: 1456px; width: 47px;"><div class="ace_gutter-cell " style="height: 28px;">1<span class="ace_fold-widget ace_start ace_open" style="height: 28px;"></span></div><div class="ace_gutter-cell " style="height: 28px;">2</div><div class="ace_gutter-cell " style="height: 28px;">3</div><div class="ace_gutter-cell " style="height: 28px;">4</div><div class="ace_gutter-cell " style="height: 28px;">5</div><div class="ace_gutter-cell " style="height: 28px;">6</div><div class="ace_gutter-cell " style="height: 28px;">7</div><div class="ace_gutter-cell " style="height: 28px;">8</div><div class="ace_gutter-cell " style="height: 28px;">9</div><div class="ace_gutter-cell " style="height: 28px;">10<span class="ace_fold-widget ace_start ace_open" style="height: 28px;"></span></div><div class="ace_gutter-cell " style="height: 28px;">11</div><div class="ace_gutter-cell " style="height: 28px;">12</div><div class="ace_gutter-cell " style="height: 28px;">13</div><div class="ace_gutter-cell " style="height: 28px;">14</div><div class="ace_gutter-cell " style="height: 28px;">15</div><div class="ace_gutter-cell " style="height: 28px;">16</div><div class="ace_gutter-cell " style="height: 28px;">17</div><div class="ace_gutter-cell " style="height: 28px;">18</div><div class="ace_gutter-cell " style="height: 28px;">19</div><div class="ace_gutter-cell " style="height: 28px;">20</div><div class="ace_gutter-cell " style="height: 28px;">21</div><div class="ace_gutter-cell " style="height: 28px;">22</div><div class="ace_gutter-cell " style="height: 28px;">23</div><div class="ace_gutter-cell " style="height: 28px;">24<span class="ace_fold-widget ace_start ace_open" style="height: 28px;"></span></div><div class="ace_gutter-cell " style="height: 28px;">25<span class="ace_fold-widget ace_start ace_open" style="height: 28px;"></span></div><div class="ace_gutter-cell " style="height: 28px;">26</div><div class="ace_gutter-cell " style="height: 28px;">27<span class="ace_fold-widget ace_end ace_open" style="height: 28px;"></span></div><div class="ace_gutter-cell " style="height: 28px;">28<span class="ace_fold-widget ace_start ace_open" style="height: 28px;"></span></div><div class="ace_gutter-cell " style="height: 28px;">29</div><div class="ace_gutter-cell " style="height: 28px;">30</div><div class="ace_gutter-cell " style="height: 28px;">31</div></div><div class="ace_gutter-active-line" style="top: 0px; height: 28px;"></div></div><div class="ace_scroller" style="left: 48px; right: 0px; bottom: 0px;"><div class="ace_content" style="margin-top: 0px; width: 608px; height: 1456px; margin-left: 0px;"><div class="ace_layer ace_print-margin-layer"><div class="ace_print-margin" style="left: 564px; visibility: hidden;"></div></div><div class="ace_layer ace_marker-layer"><div class="ace_active-line" style="height:28px;top:0px;left:0;right:0;"></div></div><div class="ace_layer ace_text-layer" style="padding: 0px 4px;"><div class="ace_line_group" style="height:28px"><div class="ace_line" style="height:28px"><span class="ace_markup ace_heading ace_1">#</span><span class="ace_heading">&nbsp;Django&nbsp;Polls&nbsp;app</span></div></div><div class="ace_line_group" style="height:28px"><div class="ace_line" style="height:28px"><span class="ace_text ace_xml">Polls&nbsp;is&nbsp;a&nbsp;simple&nbsp;Django&nbsp;app&nbsp;to&nbsp;conduct&nbsp;Web-based&nbsp;polls.&nbsp;For&nbsp;each</span></div></div><div class="ace_line_group" style="height:28px"><div class="ace_line" style="height:28px"><span class="ace_text ace_xml">question,&nbsp;visitors&nbsp;can&nbsp;choose&nbsp;between&nbsp;a&nbsp;fixed&nbsp;number&nbsp;of&nbsp;answers.</span></div></div><div class="ace_line_group" style="height:28px"><div class="ace_line" style="height:28px"></div></div><div class="ace_line_group" style="height:28px"><div class="ace_line" style="height:28px"><span class="ace_text ace_xml">A&nbsp;simple&nbsp;Django&nbsp;poll&nbsp;app&nbsp;consist&nbsp;of&nbsp;two&nbsp;parts:</span></div></div><div class="ace_line_group" style="height:28px"><div class="ace_line" style="height:28px"></div></div><div class="ace_line_group" style="height:28px"><div class="ace_line" style="height:28px"><span class="ace_markup ace_list">-&nbsp;</span><span class="ace_list">A&nbsp;public&nbsp;site&nbsp;that&nbsp;lets&nbsp;people&nbsp;view&nbsp;polls&nbsp;and&nbsp;vote&nbsp;in&nbsp;them.</span></div></div><div class="ace_line_group" style="height:28px"><div class="ace_line" style="height:28px"><span class="ace_markup ace_list">-&nbsp;&nbsp;</span><span class="ace_list">An&nbsp;admin&nbsp;site&nbsp;that&nbsp;lets&nbsp;you&nbsp;add,&nbsp;change,&nbsp;and&nbsp;delete&nbsp;polls.</span></div></div><div class="ace_line_group" style="height:28px"><div class="ace_line" style="height:28px"></div></div><div class="ace_line_group" style="height:28px"><div class="ace_line" style="height:28px"><span class="ace_markup ace_heading ace_1">#</span><span class="ace_heading">&nbsp;Initial&nbsp;Setup</span></div></div><div class="ace_line_group" style="height:28px"><div class="ace_line" style="height:28px"></div></div><div class="ace_line_group" style="height:28px"><div class="ace_line" style="height:28px"><span class="ace_markup ace_list">&nbsp;&nbsp;-&nbsp;</span><span class="ace_list">Add&nbsp;"polls"&nbsp;to&nbsp;your&nbsp;INSTALLED_APPS&nbsp;setting&nbsp;like&nbsp;this::</span></div></div><div class="ace_line_group" style="height:28px"><div class="ace_line" style="height:28px"><span class="ace_list">&nbsp;&nbsp;&nbsp;&nbsp;INSTALLED_APPS&nbsp;=&nbsp;[</span></div></div><div class="ace_line_group" style="height:28px"><div class="ace_line" style="height:28px"><span class="ace_list">...</span></div></div><div class="ace_line_group" style="height:28px"><div class="ace_line" style="height:28px"><span class="ace_indent-guide">&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="ace_list">&nbsp;&nbsp;&nbsp;&nbsp;'polls',</span></div></div><div class="ace_line_group" style="height:28px"><div class="ace_line" style="height:28px"><span class="ace_list">&nbsp;&nbsp;&nbsp;&nbsp;]</span></div></div><div class="ace_line_group" style="height:28px"><div class="ace_line" style="height:28px"><span class="ace_markup ace_list">&nbsp;&nbsp;-&nbsp;</span><span class="ace_list">Include&nbsp;the&nbsp;polls&nbsp;URLconf&nbsp;in&nbsp;your&nbsp;project&nbsp;urls.py&nbsp;like&nbsp;this:</span></div></div><div class="ace_line_group" style="height:28px"><div class="ace_line" style="height:28px"><span class="ace_list">&nbsp;&nbsp;&nbsp;&nbsp;path('polls/',&nbsp;include('polls.urls')),</span></div></div><div class="ace_line_group" style="height:28px"><div class="ace_line" style="height:28px"><span class="ace_markup ace_list">&nbsp;&nbsp;-&nbsp;</span><span class="ace_list">Run&nbsp;</span><span class="ace_support ace_function">`python&nbsp;manage.py&nbsp;migrate`</span><span class="ace_list">&nbsp;to&nbsp;create&nbsp;the&nbsp;polls&nbsp;models.</span></div></div><div class="ace_line_group" style="height:28px"><div class="ace_line" style="height:28px"><span class="ace_markup ace_list">&nbsp;&nbsp;-&nbsp;</span><span class="ace_list">Start&nbsp;the&nbsp;development&nbsp;server&nbsp;and&nbsp;visit&nbsp;http://127.0.0.1:8000/admin/</span></div></div><div class="ace_line_group" style="height:28px"><div class="ace_line" style="height:28px"><span class="ace_list">&nbsp;&nbsp;&nbsp;to&nbsp;create&nbsp;a&nbsp;poll&nbsp;(you'll&nbsp;need&nbsp;the&nbsp;Admin&nbsp;app&nbsp;enabled).</span></div></div><div class="ace_line_group" style="height:28px"><div class="ace_line" style="height:28px"><span class="ace_markup ace_list">&nbsp;&nbsp;-&nbsp;</span><span class="ace_list">Visit&nbsp;http://127.0.0.1:8000/polls/&nbsp;to&nbsp;participate&nbsp;in&nbsp;the&nbsp;poll.</span></div></div><div class="ace_line_group" style="height:28px"><div class="ace_line" style="height:28px"></div></div><div class="ace_line_group" style="height:28px"><div class="ace_line" style="height:28px"><span class="ace_markup ace_heading ace_3">###</span><span class="ace_heading">&nbsp;Installation</span></div></div><div class="ace_line_group" style="height:28px"><div class="ace_line" style="height:28px"><span class="ace_support ace_function">```sh</span></div></div><div class="ace_line_group" style="height:28px"><div class="ace_line" style="height:28px"><span class="ace_support ace_function">$&nbsp;pip&nbsp;install&nbsp;django&nbsp;</span></div></div><div class="ace_line_group" style="height:28px"><div class="ace_line" style="height:28px"><span class="ace_support ace_function">```</span></div></div><div class="ace_line_group" style="height:28px"><div class="ace_line" style="height:28px"><span class="ace_markup ace_heading ace_3">###</span><span class="ace_heading">&nbsp;Requirements</span></div></div><div class="ace_line_group" style="height:28px"><div class="ace_line" style="height:28px"><span class="ace_text ace_xml">Django&nbsp;1.10+,&nbsp;Python&nbsp;2.7,&nbsp;3.4+</span></div></div><div class="ace_line_group" style="height:28px"><div class="ace_line" style="height:28px"></div></div><div class="ace_line_group" style="height:28px"><div class="ace_line" style="height:28px"></div></div></div><div class="ace_layer ace_marker-layer"></div><div class="ace_layer ace_cursor-layer ace_hidden-cursors"><div class="ace_cursor" style="left: 4px; top: 0px; width: 7px; height: 28px;"></div></div></div></div><div class="ace_scrollbar ace_scrollbar-v" style="display: none; width: 22px; bottom: 0px;"><div class="ace_scrollbar-inner" style="width: 22px; height: 868px;"></div></div><div class="ace_scrollbar ace_scrollbar-h" style="display: none; height: 22px; left: 48px; right: 0px;"><div class="ace_scrollbar-inner" style="height: 22px; width: 615px;"></div></div><div style="height: auto; width: auto; top: -100px; left: -100px; visibility: hidden; position: fixed; white-space: pre; font: inherit; overflow: hidden;"><div style="height: auto; width: auto; top: -100px; left: -100px; visibility: hidden; position: fixed; white-space: pre; font: inherit; overflow: visible;"></div><div style="height: auto; width: auto; top: -100px; left: -100px; visibility: hidden; position: fixed; white-space: pre; font-style: inherit; font-variant: inherit; font-stretch: inherit; font-size: inherit; line-height: inherit; font-family: inherit; overflow: visible;">XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX</div></div></div>
</div>

        <div id="preview1" class="g-b g-b--t1of2 split split-preview">
  <div id="preview" class="preview-html" preview="" debounce="150"><h1><a id="Django_Polls_app_0"></a>Django Polls app</h1>
<p>Polls is a simple Django app to conduct Web-based polls. For each<br>
question, visitors can choose between a fixed number of answers.</p>
<p>A simple Django poll app consist of two parts:</p>
<ul>
...
<h1><a id="Initial_Setup_9"></a>Initial Setup</h1>
<ul>
<li>Add “polls” to your INSTALLED_APPS setting like this::<br>
INSTALLED_APPS = [<br>
…<br>
‘polls’,<br>
]</li>
<li>Include the polls URLconf in your project <a href="http://urls.py/">urls.py</a> like this:<br>
path(‘polls/’, include(‘polls.urls’)),</li>
<li>Run <code>python manage.py migrate</code> to create the polls models.</li>
<li>Start the development server and visit <a href="http://127.0.0.1:8000/admin/">http://127.0.0.1:8000/admin/</a><br>
to create a poll (you’ll need the Admin app enabled).</li>
<li>Visit <a href="http://127.0.0.1:8000/polls/">http://127.0.0.1:8000/polls/</a> to participate in the poll.</li>
</ul>
<h3><a id="Installation_23"></a>Installation</h3>
<pre><code class="language-sh">$ pip install django 
</code></pre>
<h3><a id="Requirements_27"></a>Requirements</h3>
<p>Django 1.10+, Python 2.7, 3.4+</p>
</div>
</div>
...
<script>
  ...
  <script src="./Readme_files/bundle.js.download" type="text/javascript" async=""></script>
